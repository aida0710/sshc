...
test("shows OS icons and editable paste and close dialogs with synthetic connections", async ({ page, context, installation }) => {
  ...
  if (dir !== undefined) {
    ...
    await page.screenshot({ path: `${dir}/home-os-icons.png`, fullPage: true });
  }
  ...
  if (dir !== undefined) await page.screenshot({ path: `${dir}/editable-paste.png`, fullPage: true });
  ...
  if (dir !== undefined) await page.screenshot({ path: `${dir}/close-dialog-focus.png`, fullPage: true });
});
