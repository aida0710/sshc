...
export function MissingConnection({ onBackToList }: { onBackToList: () => void }) {
  ...
  return (
    <section className="m-auto flex max-w-sm flex-col items-center rounded-2xl bg-tree px-8 py-10 text-center" role="status">
...
export function NoConnectionSelected({
  ...
  return (
    <section className="m-auto flex max-w-sm flex-col items-center rounded-2xl bg-tree px-8 py-10 text-center" role="status">
      <span
        aria-hidden="true"
        className="mb-4 flex size-14 items-center justify-center rounded-2xl bg-card text-accent shadow-sm"
      >
