...
export const en = {
  ...
  "settings.pageDescription": "Choose how sshc opens connections, starts, and protects this machine's encrypted data.",
  "settings.terminalHeading": "Default connection application",
  "settings.terminalDescription": "This applies to every connection opened from Home or Connections.",
  "settings.terminalOpenWith": "Open connections with",
  "settings.terminalOtherApplication": "Another application…",
  "settings.terminalNotInstalled": "Not installed",
  "settings.terminalApplication": "Application",
  "settings.terminalChooseApplication": "Choose an application",
  "settings.terminalArguments": "Arguments",
  "settings.terminalArgumentsHint": "Separate argv items with spaces. No shell is used.",
  "settings.terminalSaveCustom": "Save custom application",
  "settings.terminalSaving": "Saving…",
  "settings.terminalSaved": "The default connection application was saved.",
  "settings.terminalLoading": "Reading available connection applications…",
  "settings.terminalLoadFailed": "The available connection applications could not be read.",
  "settings.terminalSaveFailed": "The default connection application could not be saved.",
  "settings.terminalUnsupported": "This platform does not provide a terminal launcher. Run the SSH command yourself.",
  ...
  "browser.navLabel": "Connections",
  "browser.modeLabel": "Browse connections by",
  "browser.servers": "Servers",
  "browser.groups": "Groups",
  "browser.filter": "Filter connections",
  "browser.filterPlaceholder": "alias, pattern, group or tag",
  ...
  "browser.emptyServers": "No concrete Host alias is configured yet.",
  ...
  "browser.groupMissingDetail": "The URL names {name}, but that declared group no longer exists.",
  ...
  "conn.analysisExplainedHint": "These values and sources are read without running OpenSSH. Complex Match behavior remains approximate.",
  "conn.analysisAuthoritative": "Authoritative OpenSSH result",
  "conn.analysisAuthoritativeHint": "Run ssh -G explicitly when you need OpenSSH's final interpretation of the saved connection.",
  "conn.analysisRun": "Run authoritative ssh -G",
  "conn.analysisRunning": "Running ssh -G…",
  "conn.analysisRunConfirmed": "Run ssh -G with these directives",
  "conn.analysisExecutableHeading": "ssh -G may execute Match directives",
  "conn.analysisSources": "Authoritative value sources",
  "conn.analysisRefused": "OpenSSH refused the analysis with exit code {code}.",
  ...
  "host.organisationSaveNote": "Each organisation action saves independently; it is not part of Save Basic settings.",
...
export const ja: Record<MessageKey, string> = {
  ...
  "section.settings": "設定",
  "settings.heading": "設定",
  "settings.pageDescription": "接続を開くアプリ、sshc の起動方法、このマシンの暗号化データの保護を設定します。",
  "settings.terminalHeading": "既定の接続アプリ",
  "settings.terminalDescription": "Home と接続先から開く、すべての接続に適用されます。",
  "settings.terminalOpenWith": "接続を開くアプリ",
  "settings.terminalOtherApplication": "その他のアプリ…",
  "settings.terminalNotInstalled": "未インストール",
  "settings.terminalApplication": "アプリケーション",
  "settings.terminalChooseApplication": "アプリケーションを選択",
  "settings.terminalArguments": "引数",
  "settings.terminalArgumentsHint": "argv の各項目を空白で区切ります。シェルは使用しません。",
  "settings.terminalSaveCustom": "カスタムアプリを保存",
  "settings.terminalSaving": "保存しています…",
  "settings.terminalSaved": "既定の接続アプリを保存しました。",
  "settings.terminalLoading": "利用できる接続アプリを読み込んでいます…",
  "settings.terminalLoadFailed": "利用できる接続アプリを読み込めませんでした。",
  "settings.terminalSaveFailed": "既定の接続アプリを保存できませんでした。",
  "settings.terminalUnsupported": "この環境では端末を起動できません。SSH コマンドを手動で実行してください。",
  ...
  "browser.navLabel": "接続一覧",
  "browser.modeLabel": "接続の表示方法",
  "browser.servers": "サーバー",
  "browser.groups": "グループ",
  "browser.filter": "接続を絞り込む",
  "browser.filterPlaceholder": "alias、パターン、グループ、タグ",
  ...
  "conn.analysisRunning": "ssh -G を実行しています…",
  "conn.analysisRunConfirmed": "このディレクティブを許可して ssh -G を実行",
  "conn.analysisExecutableHeading": "ssh -G がMatchディレクティブを実行する可能性があります",
  "conn.analysisSources": "権威ある値の出所",
  "conn.analysisRefused": "OpenSSHは終了コード {code} で解析を拒否しました。",
  ...
  "host.organisationSaveNote": "整理の各操作は個別に保存され、「基本設定を保存」には含まれません。",
