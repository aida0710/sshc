...
export const ja = {
  ...
  "secrets.totpHost": "接続先エイリアス",
  "secrets.totpCredential": "ワンタイムパスワード",
  "secrets.chooseTOTP": "保存済みトークンを選択",
  "secrets.assignTOTP": "接続先へ割り当て",
  "secrets.assignTOTPFailed": "この接続先へワンタイムパスワードを割り当てられませんでした。",
