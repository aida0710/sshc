...
export const ja = {
  ...
  "palette.open": "横断検索",
  "palette.heading": "ホスト・ファイル・スニペット・設定を検索",
  "palette.placeholder": "ホスト、ファイル、スニペット、設定を検索",
  ...
  "workspace.groupCount": "{count}台のターミナル",
  ...
  "workspace.secretSnippetRefused": "秘密変数を含むスニペットは、値がターミナル表示やshell履歴に残る可能性があるため送信できません。",
  ...
  "workspace.executionNotice": "各ターミナルの現在の入力先へコマンドとEnterを送信するため、作業ディレクトリ・環境・shell状態をそのまま使います。入力途中の文字や実行中のフォアグラウンドプロセスがある場合は、その続きまたは標準入力として扱われることがあります。",
  "workspace.previewHeading": "ターミナルへ送る内容の確認",
  "workspace.sendTargets": "{count}台のターミナルへ送信",
  ...
  "terminal.manualReconnectFailed": "SSHセッションへ再接続できませんでした。接続設定とネットワークを確認して、もう一度試してください。",
  ...
  "home.savedWorkspacesHint": "保存した接続先とペイン配置を、新しいSSH接続としてまとめて開きます。",
  ...
  "home.allGroups": "すべて",
  "home.connectionCount": "{count}件",
  "home.pointerHint": "マウス: ダブルクリック · タッチ: 1回タップ",
  "home.touchHint": "1回タップで接続",
  "home.connectGesture": "{alias}へ接続。マウスではダブルクリック、タッチ画面では1回タップします。",
  "home.neverConnected": "未接続",
  ...
  "sync.role.main": "メイン端末（送信と受信）",
  "sync.role.receive": "受信専用端末",
  "sync.role.advanced": "詳細な端末ロール",
  "sync.role.send": "送信専用端末",
  ...
  "sync.commitMessageChanges": "ローカル差分: 追加{added}・変更{modified}・削除{removed}",
  "sync.commitMessageInvalid": "コミットメッセージは240文字以内の一行で入力してください。",
  "sync.bucketStateHeading": "バケットの状態",
  "sync.bucketStateHint": "暗号化された内容は取得せず、現在のスナップショットと日付付き履歴をS3から直接確認します。画面表示中は30秒ごと、送受信後にも更新します。",
  ...
  "sync.bucketLocalCurrent": "このマシンは現在のリモート世代を確認済みです。",
  "sync.bucketLocalBehind": "リモート世代が、このマシンで最後に確認したスナップショットと異なります。",
  "sync.bucketHistory": "日付付き履歴・{count}件",
  "sync.bucketHistoryTruncated": "最新10,000件を表示しています。これより古い履歴もバケットにあります。",
  ...
  "sync.historyRevisionMeta": "{at}・{count}ファイル・端末 {origin}",
  "sync.historyParent": "親 {revision}",
  "sync.historySelect": "世代を選ぶと、現在のリモートHEADとの差分を確認できます。",
  ...
  "sync.historyDiff.added": "追加・{count}",
  "sync.historyDiff.modified": "変更・{count}",
  "sync.historyDiff.removed": "削除・{count}",
  "sync.historyRestoreHint": "復元前にローカル変更をプレビューします。リモートHEADは巻き戻さず、次の送信でこの世代を親にした新しいHEADを作ります。",
  "sync.historyRestorePreview": "この世代の復元を確認",
  "sync.forceHeading": "リモートスナップショットを置き換える",
  "sync.forceHint": "読み取れない、または不要なスナップショットが入った別バケットへ変更した場合に使います。このワークスペースを暗号化し、上に表示したリモート世代だけを置き換えます。確認後に世代が変わった場合は中止します。既存の日付付き履歴は削除しません。",
  ...
  "tree.favouritesOnlyAction": "お気に入りだけ表示",
  "tree.dragGroupHint": "グループをドラッグすると、入れ子や並びを変更できます。",
