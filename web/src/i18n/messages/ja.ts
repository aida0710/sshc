...
export const ja = {
  ...
  "sftp.splitPane": "2ペイン",
  "sftp.singlePane": "1ペイン",
  "sftp.firstPane": "1つ目のリモートペイン",
  "sftp.secondPane": "2つ目のリモートペイン",
  "sftp.local.mode": "ローカルファイル",
  "sftp.local.remoteMode": "リモートファイル",
  "sftp.local.heading": "ローカルファイル",
  "sftp.local.choose": "フォルダを選択",
  "sftp.local.refresh": "ローカルフォルダを更新",
  "sftp.local.unsupported": "このブラウザでは書き込み可能なローカルフォルダを開けません。HTTPSまたはlocalhostで、対応するPCブラウザを使用してください。",
  "sftp.local.chooseHint": "このPCのフォルダを選ぶと、ファイルを表示して転送できます。",
  ...
  "sftp.chooseHostHint": "保存済みのSSHホストを選び、接続してください。",
  "sftp.connect": "接続",
  ...
  "sftp.places": "ブックマークと最近開いたパス",
  "sftp.addBookmark": "このフォルダーをブックマーク",
  "sftp.removeBookmark": "このブックマークを解除",
  "sftp.removeBookmarkFor": "{path} のブックマークを解除",
  "sftp.bookmarks": "ブックマーク",
  "sftp.recentPaths": "最近開いたパス",
  "sftp.noPlaces": "フォルダーをブックマークすると、ここから開けます。",
