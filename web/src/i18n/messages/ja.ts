...
export const ja = {
  ...
  "terminal.reconnectHint":
    "予期せず切断された場合の再接続回数です。再試行間隔は 1、2、5、10、15 秒で、5 回の場合は最大 33 秒かかります。手動で閉じたコンソールは再接続しません。",
  "terminal.reconnectDefault": "既定（5 回・最大 33 秒）",
  "terminal.reconnectNever": "繋ぎ直さない",
  "terminal.reconnectOnce": "1 回（最大 1 秒）",
  "terminal.reconnectTwice": "2 回（最大 3 秒）",
  "terminal.reconnectThrice": "3 回（最大 8 秒）",
  "terminal.reconnectFive": "5 回（最大 33 秒）",
  "engine.heading": "エンジン",
