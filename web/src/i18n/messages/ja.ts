...
export const ja = {
  ...
  "terminal.verbosityHint": "ssh -v と同じく、コンソールそのものへ書きます。次の接続から効きます。",
  "terminal.verbosityQuiet": "何も言わない",
  "terminal.verbosityBrief": "何が起きたか（-v）",
  ...
  "terminal.reconnectHint":
    "相手が落ちたときに、何回まで繋ぎ直しを試みるかです。**閉じたコンソールがしばらく残って見えるのは、ここが粘っているあいだです。** 間隔は 1・2・5・10・15 秒なので、5 回なら諦めるまで 33 秒かかります。自分で閉じたときは待たずに消えます。",
