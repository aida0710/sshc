...
export const ja = {
  ...
  "shell.vaultChecking": "保護された内容を再表示する前に、Vault のロック状態を確認しています…",
  "shell.vaultCheckRetrying": "Vault の状態を確認できませんでした。保護された内容を隠したまま再試行します。",
  ...
  "shell.pageNotFoundDescription": "この URL に対応する sshc の画面はありません。",
  "shell.goHome": "ホームへ移動",
  ...
  "workspace.oneLiveOnly": "現在のワークスペースを閉じてから、別のワークスペースを作成してください。",
  ...
  "workspace.movePane": "{alias} のペインを移動します。移動先のペインを選んでください。",
  "workspace.movePanePicked": "{alias} を選択中です。移動先のペインを選んでください。",
  "workspace.reconnecting": "このペインを再接続してください。",
  "workspace.maxPanes": "1 つのワークスペースに配置できるのは最大 {count} ペインです。",
  "workspace.namePrompt": "保存レイアウト名",
  "workspace.savedLayouts": "保存レイアウト",
  "workspace.savedDescription": "SSH 接続先、ローカルシェル、ペイン配置を名前付きで保存し、あとで新しいセッションとして開き直せます。1 レイアウトにつき最大 {count} ペインです。",
  ...
  "workspace.executionNotice": "各ターミナルの現在の入力先へコマンドとEnterを送信するため、作業ディレクトリ、環境、シェルの状態をそのまま使います。入力途中の文字や実行中のフォアグラウンドプロセスがある場合は、その続きまたは標準入力として扱われることがあります。",
  "workspace.previewHeading": "ターミナルへ送る内容の確認",
  "workspace.sendTargets": "{count} セッションへ送信",
  "workspace.deliveryResults": "送信結果",
  "workspace.deliveryNotice": "出力は各ターミナルに表示されます。送信済みはコマンドの完了を意味しません。",
  ...
  "snippets.startupHint": "選択したホストのシェル準備後に実行します。シークレット変数は使用できません。",
  ...
  "terminal.browserNotificationsDefault": "このタブがバックグラウンドにあるとき、Coding Agent の完了や入力待ちを sshc から通知できます。",
  "terminal.browserNotificationsGranted": "ブラウザ通知は許可されています。このタブがバックグラウンドにあるときだけ通知します。",
  "terminal.browserNotificationsDenied": "sshc の通知がブロックされています。Coding Agent の通知を使うには、ブラウザのサイト設定で通知を許可してください。",
  ...
  "terminal.notificationVolumeHint": "{volume}% · 両方のAgent通知音に適用されます",
  ...
  "terminal.quickCommandContextWarning": "挿入と実行は、ペインの現在の入力先へ文字を送ります。入力途中の文字列や、パスワード／パスフレーズなどを求めるフォアグラウンドの入力待ちへ続けて送られる場合があります。",
  ...
  "terminal.agentResumeFailed": "Coding Agent のセッションを再開できませんでした。",
  "terminal.agentResumeStale": "Coding Agent セッションの状態が変わりました。確認してからもう一度お試しください。",
  "terminal.agentResumeSamePaneBusy": "このシェルにはすでに入力があります。新しいペインで再開してください。",
  "terminal.agentResumeUnavailable": "この Coding Agent セッションは再開できません。",
  "terminal.agentResumeIdentityChanged": "この alias の SSH 接続先が変わったため、Coding Agent セッションを再開しませんでした。",
  ...
  "terminal.closeForwards": "このセッションのポート転送 {count} 件も終了します。",
  ...
  "terminal.limitReached": "同時に開けるセッション数の上限（{max}）に達しました。どれかを閉じてください。",
  "terminal.limitRefused": "これ以上セッションを開けません。どれかを閉じてください。",
  "terminal.unresolvable": "この接続の設定を解決できませんでした。理由は「Analysis」で確認できます。",
  ...
  "terminal.identityUnavailable": "利用できる秘密鍵または ssh-agent の鍵がありません。",
  ...
  "terminal.manualReconnectFailed": "SSH セッションへ再接続できませんでした。接続設定とネットワークを確認して、もう一度試してください。",
  ...
  "terminal.linkWaiting": "接続が切れました。{seconds} 秒後に {attempt} 回目の再接続を試みます。",
  ...
  "terminal.copyContextHint": "制御シーケンスを除き、直近最大 200 行をコピーします",
  "terminal.copyContextDone": "直近のターミナル出力をコピーしました。",
  "terminal.copyContextEmpty": "コピーできるターミナル出力がありません。",
  "terminal.osc52Hint": "このターミナルセッションから OSC 52 でシステムのクリップボードへ書き込むことを許可します",
  "terminal.osc52Enabled": "このターミナルセッションで OSC 52 のクリップボード書き込みを許可しました。",
  "terminal.osc52Disabled": "OSC 52 のクリップボード書き込みを拒否します。",
  "terminal.osc52Copied": "リモートアプリがシステムのクリップボードへコピーしました。",
  "terminal.moreActions": "ターミナルのその他の操作",
  "terminal.portForwarding": "ポート転送",
  "terminal.forwardDescription": "{title} の接続中の SSH を使うトンネルを管理します。",
  ...
  "terminal.forwardSavedStopHint": "ここで停止しても接続設定からは削除されません。",
  "terminal.forwardRetryHint": "ローカルポートの競合を解消し、このSSHを再接続すると保存済み転送を再試行します。",
  ...
  "terminal.forwardSaveHint": "今すぐ開始し、次回この接続を開いたときにも復元します。",
  "terminal.forwardSaveUnavailable": "ローカルシェルまたは未保存の接続には設定を保存できません。",
  "terminal.forwardNeedsConnection": "SSHを再接続してから転送を開始してください。",
  ...
  "terminal.forwardUnavailable": "現在のSSH接続ではポート転送を変更できません。",
  "terminal.forwardInvalid": "転送の種類、ポート、転送先を確認してください。",
  "terminal.forwardSaveFailed": "転送は開始しましたが、接続設定へ保存できませんでした。",
  ...
  "terminal.maxSessionsHint": "1〜200。空欄の場合は 50 です。上限に達すると新しいセッションを開けません。既存のセッションは自動的に閉じられません。",
  "terminal.scrollbackLabel": "Engine再生バッファ（バイト）",
  "terminal.scrollbackHint": "ブラウザ再接続時にengineが再生する出力です。16384〜4194304、空欄は262144（256 KiB）。メモリだけに保持し、ディスクへ書きません。",
  "terminal.browserScrollbackLabel": "ブラウザのスクロールバック（行）",
  "terminal.browserScrollbackHint": "各ブラウザ端末が保持する行数です。1000〜100000、空欄は5000。増やすほどブラウザのメモリを使用します。",
  "terminal.localShellProfileLabel": "既定のローカルシェル",
  "terminal.localShellProfileHint": "このマシンで検出・検証できた実行ファイルから選びます。ローカル端末を開くときだけ別のシェルを選ぶこともできます。",
  "terminal.localShellProfileSystem": "システムのログインシェル",
  "terminal.osc52DefaultLabel": "OSC 52のクリップボード書き込みを既定で許可",
  "terminal.osc52DefaultHint": "ローカルシェルはこの設定を使います。SSH接続ごとに継承・許可・拒否を選べます。",
  "terminal.jisYenBackslashLabel": "JIS配列の¥キーをbackslashとして送る",
  "terminal.jisYenBackslashHint": "日本語キーボード向けです。IME変換中の入力は変更しません。",
  "terminal.fontSizeLabel": "文字の大きさ",
  "terminal.paletteLabel": "配色",
  "terminal.verbosityLabel": "接続のログ",
  "terminal.verbosityHint": "ssh -v と同等の接続情報をターミナルへ表示します。新しい接続から適用されます。",
  ...
  "terminal.paletteHint": "個別の配色を指定していないターミナルに適用されます。",
  ...
  "connection.osc52Hint": "このSSH接続上のremote applicationによるシステムクリップボードへの書き込みを選びます。",
  ...
  "terminal.exitedWithCode": "プログラムが終了コード {code} で終了しました。出力は、このセッションを閉じるまで表示されます。",
  "terminal.exitedWithSignal": "プログラムがシグナル {signal} で終了しました。出力は、このセッションを閉じるまで表示されます。",
  ...
  "secrets.pageDescription": "名前付きのアカウントパスワードと鍵パスフレーズを管理します。値は編集時だけ表示されます。",
  ...
  "secrets.editNote": "保存済みの値を表示しています。名前を変更しても、現在の割り当て先は維持されます。",
  ...
  "secrets.nameExists": "同じ名前の認証情報が既にあります。別の名前を指定してください。",
  ...
  "desktop.closeAllNote": "すべてのセッション、ポート転送、ssh-agent 転送を終了します。エンジンは動作を続けます。",
  ...
  "lock.alreadyExists": "アプリ内に Vault が見つかりました。マスターパスワードを入力して開いてください。",
  "lock.storagePermission": "Android がアプリ専用ストレージへのアクセスを拒否しました。下の詳細をコピーして共有してください。",
  "lock.storageFull": "空き容量が不足しているため Vault を作成または更新できません。",
  ...
  "lock.envelopeUnsupported": "この形式の暗号化 Vault には対応していません。診断情報を開いて共有してください。",
  ...
  "home.quickConnectHint": "最近接続した順に表示し、未接続の接続先は名前順に並べます。",
  ...
  "home.savedWorkspacesHint": "保存した接続先とペイン配置を、新しい SSH 接続としてまとめて開きます。",
  ...
  "home.connectGesture": "{alias} へ接続します。マウスではダブルクリック、タッチ画面では 1 回タップします。",
  "home.neverConnected": "接続履歴なし",
  "home.loading": "SSH 設定を読み込んでいます…",
  "home.noConnections": "接続先がまだありません。SSH Config に Host を追加してください。",
  ...
  "diagnostic.requestFailedHint": "sshc でエラーが発生しました（{code}）。問い合わせの際は診断情報を確認してください。",
  ...
  "notice.dangerous_directive": "このディレクティブはコマンドを実行する可能性があります。記述どおりに保存され、このアプリが実行することはありません。",
  ...
  "notice.match_final_refused": "この設定には Match final があります。OpenSSH は設定を二度読み込みますが、sshc はこの処理に対応していないため値を解決できません。",
  "notice.canonicalise_refused": "この設定は CanonicalizeHostname を有効にしています。設定を読み直す必要があるため、ここでは値を解決できません。",
  "notice.unknown_token_refused": "この設定では、sshc が対応していないトークンを使用しています。値を解決できません。",
  "notice.destination_not_included": "このファイルは SSH Config から参照されていないため、OpenSSH に読み込まれません。Include 設定を追加してください。",
  ...
  "notice.include_no_longer_matches": "ファイル名を変更すると現在の Include パターンの対象外になり、OpenSSH に読み込まれなくなります。",
  "notice.include_not_rewritten":
    "sshc が自動更新できない形式の Include がこのファイルを参照しています。Include 設定を手動で確認してください。",
  "notice.include_now_unreached": "新しい保存先は SSH Config から参照されていません。Include 設定を追加するまで、OpenSSH に読み込まれません。",

  "preview.heading": "保存内容の確認",
  "preview.newFile": "（新規ファイル）",
  "preview.tooLarge": "このファイルは行単位で表示できるサイズを超えているため、ファイル全体の置換として表示します。",
  "preview.syntaxError": "{path} の {line} 行 {column} 列に構文エラーがあります。編集はここに保持され、書き込まれていません。",
  "preview.theFile": "対象ファイル",
  "preview.graphError": "この変更により Include の参照関係が不正になります。何も書き込んでいません。",
  ...
  "preview.mergeByHand": "ファイルを読み込み直し、2 つの変更を手動で統合してください。何も書き込んでいません。",
  ...
  "password.blocker.aliasNotSimple": "これは具体的なホストではなくパターンです。パスワードを保存するには、単一ホストのアカウントを指定してください。",
  ...
  "sync.setup.incomplete": "履歴はありますが、現在のスナップショットがありません。",
  "sync.setup.useAnotherPath": "新しく始める場合は、空の別パスを指定してください。",
  "sync.setup.existingKey": "この同期データと同じ暗号化キーを入力してください。保存前に実際のスナップショットを復号して確認します。",
  "sync.setup.emptyKey": "強い暗号化キーを自動生成します。自分で決めることもできます。",
  "sync.setup.save": "確認して保存",
  "sync.setup.saved": "接続情報と暗号化キーを保存しました。",
  "sync.setup.changed": "確認後に同期先の状態が変わりました。もう一度、接続を確認してください。",
  "sync.role.main": "このマシンで送受信",
  "sync.role.receive": "このマシンでは受信のみ",
  "sync.role.advanced": "同期モードの詳細設定",
  "sync.role.send": "このマシンでは送信のみ",
  "sync.pageDescription": "この SSH ワークスペースを暗号化スナップショットとして保存し、オブジェクトストレージ経由でマシン間に同期します。",
  ...
  "sync.noVault": "このマシンにはまだ Vault がありません。「Vault」で作成してから戻ってきてください。",
  ...
  "sync.autoFailedWrongKey": "このマシンの同期鍵ではリモートスナップショットを開けません。同じスナップショットの自動取得は再試行しません。",
  "sync.autoFailedSchema": "リモートスナップショットの形式に対応していません。同じスナップショットの自動取得は再試行しません。",
  ...
  "sync.commitMessageHint": "ローカル差分から自動生成します。手動送信前に編集できます。",
  "sync.commitMessageChanges": "ローカル差分：追加 {added} 件 · 変更 {modified} 件 · 削除 {removed} 件",
  "sync.commitMessageInvalid": "コミットメッセージは 240 文字以内の 1 行で入力してください。",
  "sync.bucketStateHeading": "バケットの状態",
  "sync.bucketStateHint": "暗号化された内容は取得せず、現在のスナップショットと日付付き履歴を S3 から直接確認します。画面表示中は 30 秒ごと、送受信後にも更新します。",
  ...
  "sync.bucketLocalCurrent": "このマシンは現在のリモートスナップショットを確認済みです。",
  "sync.bucketLocalBehind": "リモートスナップショットが、このマシンで最後に確認した内容から更新されています。",
  "sync.bucketHistory": "日付付き履歴 · {count} 件",
  "sync.bucketHistoryTruncated": "最新 10,000 件を表示しています。これより古い履歴もバケットにあります。",
  ...
  "sync.historyHint": "このマシン上で最近の履歴を上限付きで復号し、コミットグラフとして表示します。ファイル内容はAPI応答へ出しません。",
  ...
  "sync.historyTruncated": "上限内の新しい履歴だけを復号しています。古い履歴ファイルは上のバケット一覧に残っています。",
  "sync.historySkipped": "現在の形式または暗号化キーで開けない履歴ファイルを {count} 件スキップしました。",
  ...
  "sync.historySelect": "世代を選ぶと、現在のリモート最新版との差分を確認できます。",
  ...
  "sync.historyRestoreHint": "復元前にローカルの変更内容を確認します。リモートの最新版は巻き戻さず、次の送信でこの世代を親にした新しい最新版を作ります。",
  "sync.historyRestorePreview": "この世代の復元を確認",
  "sync.forceHeading": "リモートスナップショットを置き換える",
  "sync.forceHint": "読み取れない、または不要なスナップショットがあるバケットへ変更した場合に使います。このワークスペースを暗号化し、上に表示した現在のリモートスナップショットだけを置き換えます。確認後に内容が変わった場合は中止します。既存の日付付き履歴は削除しません。",
  "sync.forceConfirm": "現在のリモートスナップショットを、このマシンのワークスペースで置き換えることを理解しました。",
  "sync.forcePush": "リモートスナップショットを置き換える",
  "sync.forcePushed": "確認したリモートスナップショットを置き換えました。",
  "sync.forceFailed": "リモートスナップショットを置き換えられませんでした。バケットの状態を更新し、もう一度確認してください。",
  ...
  "sync.remoteDeleted": "適用前に現在のリモートスナップショットが削除されました。バケットの状態を更新してください。",
  ...
  "sync.result.uploaded": "S3 転送 {size}（{count} オブジェクト、履歴＋現在版）",
  ...
  "diag.pageDescription": "保存済みの接続先だけでなく、一時的に指定したホストも検査できます。検査を開始するまで接続しません。",
  ...
  "diag.sourcesCaption": "各値の参照元。「不採用」と表示された行は、採用された行より後に読み込まれたため効果がありません。",
  ...
  "diag.superseded": "不採用",
  "diag.route": "接続経路",
  "diag.hopComplex": "このホップは alias だけで指定されていないため、接続先をここでは解決できません",
  ...
  "kh.acknowledge": "検証できていないリスクを理解したうえで、この鍵を信頼します",
  ...
  "rk.hostTypeHint": "上に Host alias を入力してください。保存済みの接続があればここに表示されます。",
  ...
  "rk.chooseHost": "接続先を 1 件以上選択するか、Host alias を入力してください。",
  ...
  "rk.planFailed": "登録内容を確認できませんでした。どのホストにも接続していません。",
  ...
  "rk.result": "結果",
  "rk.someRegistrationsFailed": "更新できなかった接続先があります。接続先ごとの結果を確認してください。",
  ...
  "groups.nestingNote": "スラッシュで階層化できます。work/eu は work の子グループです。",
  ...
  "groups.removeKeepsFiles": "設定ファイルは 1 つも削除されません。1 回の変更として履歴に残るため、あとから元に戻せます。",
  ...
  "tree.filterPlaceholderExpanded": "名前、接続先、ユーザー、グループ、タグを検索",
  ...
  "tree.dragGroupHint": "グループをドラッグすると、階層と表示順を変更できます。",
  ...
  "conn.basicKeyPassphraseDetach": "ここで保存すると、この鍵専用の値へ切り替わります。共有資格情報と、ほかの鍵への割り当ては変更しません。",
  ...
  "conn.basicGeneratedKeyStaged": "{path} をこの接続の下書きに追加しました。「基本設定を保存」で反映します。",
  ...
  "conn.checksExecutableHeading": "認証確認で SSH ディレクティブが実行される可能性があります",
  ...
  "conn.analysisExplainedHint": "この接続で使用する値です。コマンドを実行せずに解析し、解決できない設定は理由を表示します。",
  "conn.analysisAuthoritative": "各値の参照元",
  "conn.analysisAuthoritativeHint": "この接続に関係する設定行を、ファイルと行番号、実際に採用されるかどうかとともに表示します。",
  ...
  "conn.forwardLoopbackOnly": "待ち受けはこの端末内（127.0.0.1）に限定しますが、同じ端末の別OSユーザーから利用される可能性があります。Remote Forward には対応しません。",
  ...
  "conn.forwardInvalidDestination": "転送先を host:port の形式で入力してください。",
  "conn.advancedNoFields": "現在の表示条件に一致する設定はありません。",
  "conn.advancedRawBlocksFields": "Raw に未保存の変更があります。保存または破棄してからディレクティブを編集してください。",
  "conn.advancedFieldsBlockRaw": "ディレクティブに未保存の変更があります。保存または破棄してから Raw を編集してください。",
  "conn.connect": "接続",
  "conn.opening": "接続中…",
  "conn.duplicate": "接続を複製",
  "conn.manage": "その他の接続操作",
  "conn.manageLabel": "接続の管理",
  "conn.manageIndependent": "ここでの操作は、基本設定・詳細設定の変更とは別に保存されます。",
  ...
  "conn.move": "保存ファイルを変更",
  "conn.storageFileNote": "所属グループは sshc 上の整理場所です。保存ファイルを変更すると、実際に書き込む SSH 設定ファイルが変わります。通常は変更する必要はありません。",
  "conn.confirmDelete": "削除する",
  "conn.deleteHeading": "{alias} を削除しますか？",
  "conn.deleteBody": "この Host ブロックを設定から削除します。削除後も履歴から復元できます。",
  ...
  "host.dangerousField": "{keyword} は、OpenSSH がこのホストを評価するときにコマンドを実行する可能性があります。記述どおり保存され、ここで実行されることはありません。",
  "host.keep": "戻す",
  "host.remove": "削除",
  ...
  "host.displayOrder": "表示順 — 小さいほど先に並びます。0 の場合はファイル内の順序を使用します。",
  "host.tags": "タグ（カンマ区切り）",
  ...
  "keys.agentFailed": "鍵を ssh-agent に追加できませんでした。パスフレーズと ssh-agent の接続状態を確認してください。",
  ...
  "keys.inventoryEmpty": "~/.ssh にはまだファイルがありません。この画面から鍵を作成できます。",
  "keys.colFile": "ファイル",
  "keys.colKind": "種別",
  ...
  "keys.storePassphraseFailed": "パスフレーズを保存し、この鍵へ割り当てることができませんでした。",
  "keys.unassignPassphraseFailed": "この鍵への保存済みパスフレーズの割り当てを解除できませんでした。",
  ...
  "keys.removePassphrase": "パスフレーズを削除する（秘密鍵は暗号化されなくなります）",
  ...
  "keys.createUnencrypted": "パスフレーズなしで作成する（秘密鍵ファイルを読み取れるユーザーは、この鍵を使用できます）",
  ...
  "keys.relocateSkipped": "鍵名と接尾辞から構成されたファイル名ではないため、次のファイルは移動しませんでした：{paths}",
  "keys.relocateRefused": "次の理由により移動できませんでした。ファイルは変更していません：",
  ...
  "keys.blockerDestinationIsConfig": "{detail} は Include によって設定ファイルとして読み込まれる場所です",
