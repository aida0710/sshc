...
export const ja = {
  ...
  "connection.vpnLabel": "通すVPN経路",
  "connection.vpnHint": "この接続だけを、選んだVPNの中から繋ぎます。経路はVPN画面で作ります。",
  "connection.vpnNone": "VPNを通らない",
  "connection.vpnMissing": "{name}（消えたプロファイル）",
  "connection.vpnTargetMismatch": "{name}（接続先が{target}で、この接続と違う）",
  "connection.vpnTargetMismatchHint": "この接続の相手は{address}ですが、{name}が届くのは{target}だけです。接続先が一致するプロファイルを選ぶか、HostNameとPortを直してください。",
  ...
  "vpn.heading": "VPN",
  "vpn.description":
    "選んだ接続だけを専用のVPNへ通します。トンネルはengineが持つコンテナの中にあり、この端末の既定経路とDNSは変わりません。Dockerが動いている機械で使えます。",
  "vpn.loading": "VPNの設定を読み込んでいます…",
  "vpn.failed": "VPNの操作に失敗しました。",
  "vpn.unavailable": "この機械ではVPN経路を作れません: {detail}",
  "vpn.empty": "VPNプロファイルはありません。下のフォームから追加します。",
  "vpn.stateUp": "経路あり",
  "vpn.stateStarting": "接続中",
  "vpn.stateStopped": "停止中",
  "vpn.phaseImage": "イメージを用意しています",
  "vpn.phaseContainer": "コンテナを起こしています",
  "vpn.phaseTunnel": "トンネルを待っています",
  "vpn.phaseApproval": "電話の承認を待っています",
  "vpn.connect": "接続",
  "vpn.disconnect": "切断",
  "vpn.remove": "削除",
  "vpn.rename": "名前を変える",
  "vpn.renameTitle": "{name}の名前を変える",
  "vpn.renameHint": "この経路を通る接続の紐付けと、保存された秘密も新しい名前へ移ります。動いている経路はいったん畳みます。",
  "vpn.renameLabel": "新しい名前",
  "vpn.renameAction": "変更する",
  "vpn.renameEmpty": "名前を入力してください。",
  "vpn.logs": "ログ",
  "vpn.logsTitle": "{name}のログ",
  "vpn.logsHint": "コンテナの直近の出力です。秘密は伏せてあります。",
  "vpn.logsLoading": "ログを読み込んでいます…",
  "vpn.logsEmpty": "まだ出力はありません。",
  "vpn.close": "閉じる",
  "vpn.profileChip": "VPN経由: {name}",
  "vpn.profileChipHint": "この接続は、VPN経路{name}の中を通ります。",
  ...
  "vpn.privateKey": "秘密鍵",
  "vpn.username": "VPNの利用者名",
  "vpn.password": "VPNのパスワード",
  "vpn.psk": "IPsecの事前共有鍵",
  "vpn.protocol": "装置が話す方式",
  "vpn.protocolHint": "分からなければanyconnectのままにします。ocservもanyconnectです。",
  "vpn.serverCertificate": "相手の証明書の指紋",
  "vpn.serverCertificateHint": "自己署名の装置でだけ指定します（`sha256:`または`pin-sha256:`で始まる値）。空なら通常の検証をします。",
  "vpn.secondFactor": "二段目の認証",
  "vpn.secondFactorHint": "パスワードのあとに装置がすることを指定します。",
  "vpn.secondFactorNone": "なし",
  "vpn.secondFactorApprove": "電話の承認を待つ（Duo Mobileなど）",
  "vpn.secondFactorTOTP": "保存した種からコードを作る",
  "vpn.secondFactorSecret": "二段目のTOTPの種",
  "vpn.approvalWord": "二段目に送る語",
  "vpn.approvalWordHint": "装置が二段目を聞いてくる場合だけ入れます。空なら何も送りません。Duoは`push`のほか`phone`や`sms`も受け取ります。",
  "vpn.ike": "IKEの暗号方式",
  "vpn.esp": "ESPの暗号方式",
  "vpn.proposalsHint": "古い装置と合わないときだけ指定します。空なら既定に任せます。",
  "vpn.secretHint": "保存後は表示されません。",
  "vpn.cancel": "やめる",
  "vpn.save": "保存",
  "vpn.dockerMissing": "Dockerを使えません。Dockerが動いているか、このユーザーが操作できるかを確認してください。",
  "vpn.tunnelDeviceMissing": "この方式に必要なデバイスがこの機械にありません。",
  "vpn.imageBuildFailed": "VPNコンテナのイメージを作れませんでした。ネットワークとDockerを確認してください。",
  "vpn.sessionFailed": "VPNの経路が成立しませんでした。{reason}",
  "vpn.failureShowLogs": "ログを見る",
  "vpn.fieldRefused": "受け取れない値があります。項目の横の理由を確認してください。",
  "vpn.failure.unknown": "理由を読み取れませんでした。ログを確認してください。",
  "vpn.failure.timeout": "待つ上限までに経路ができませんでした。",
  "vpn.failure.server_unresolved": "VPN装置の名前を引けませんでした。サーバーの書き方を確認してください。",
  "vpn.failure.ipsec_negotiation": "IPsecが成立しませんでした。事前共有鍵と暗号方式を確認してください。",
  "vpn.failure.ppp_authentication": "PPPの認証が通りませんでした。利用者名とパスワードを確認してください。",
  "vpn.failure.openconnect_failed": "openconnectがVPN装置へ繋げませんでした。",
  "vpn.failure.handshake_timeout": "WireGuardの相手と握手できませんでした。鍵とサーバーを確認してください。",
  "vpn.failure.target_unresolved": "VPNの中で接続先の名前を引けませんでした。DNSサーバーと接続先を確認してください。",
  "vpn.failure.tunnel_lost": "用意できたあとでトンネルが切れました。",
  "vpn.containerForeign": "同じ名前の別用途のコンテナがあるため操作しません。",
  ...
  "vpn.field.format": "書き方が違います。",
  "vpn.field.too_long": "長すぎます（{limit}文字まで）。",
  "vpn.field.too_many": "多すぎます（{limit}件まで）。",
  "vpn.field.out_of_range": "ポート番号が1から65535の範囲にありません。",
  "vpn.field.not_ipv4": "IPv4アドレスではありません。",
  "vpn.field.unroutable": "ループバックなど、経路を作れないアドレスです。",
  "vpn.field.name_needs_dns": "名前で書く場合は、VPNの中のDNSサーバーも指定してください。",
  "vpn.field.unsupported": "この版が知らない値です。",
  "vpn.field.unexpected": "選んだ方式とは別の方式の設定です。",
