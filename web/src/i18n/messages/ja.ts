...
export const ja = {
  ...
  "terminal.proxyCommandRefused": "ProxyCommand はプログラムを起こしますが、sshc は接続のために何も実行しません。ProxyJump を使うか、端末から ssh で接続してください。",
  ...
  "terminal.startHeading": "ローカルシェルの開始位置",
  "terminal.startNote": "ローカルシェルはここで開き、打ったコマンドはここから実行されます。空にすると home から始まります。",
  "terminal.startLabel": "開始ディレクトリ",
  "terminal.startHint": "~/work のように書くか、絶対パスで書きます。~ は書いたまま保存するので、別の機械でも同じ意味になります。",
  "terminal.startSave": "保存",
  "terminal.startSaved": "保存しました。これから開くコンソールがそこから始まります。",
  ...
  "terminal.startSaveFailed": "開始位置を保存できませんでした。",
  ...
  "desktop.keepRunning": "ウィンドウを閉じたあとも動かし続ける",
  "desktop.loginItemWins": "ログイン時起動が有効なので、この選択にかかわらずエンジンは動き続けます。止めても OS が起こし直すためです。ウィンドウを閉じたら終わってほしい場合は、先にログイン時起動を切ってください。",
