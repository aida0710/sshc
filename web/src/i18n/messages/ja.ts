...
export const ja = {
  ...
  "inspector.consoles": "コンソール",
  "inspector.settings": "設定",
  "inspector.connectionSection": "開いている接続",
  ...
  "terminal.emptyHeading": "何も開いていません",
  "terminal.emptyHint": "パネルからコンソールを選ぶか、ローカルシェルを開いてください。",
