...
export const ja = {
  ...
  "shell.navFaceSettings": "Menu",
  "shell.navFaceTerminal": "Sessions",
  "shell.navStart": "Main",
  ...
  "workspace.maxPanes": "1つのワークスペースに配置できるのは最大{count}ペインです。",
  "workspace.namePrompt": "保存レイアウト名",
  "workspace.savedLayouts": "保存レイアウト",
  "workspace.savedDescription": "SSH接続先、ローカルシェル、ペイン配置を名前付きで保存し、あとで新しいセッションとして開き直せます。1レイアウトにつき最大{count}ペインです。",
  ...
  "terminal.agentResumeFailed": "Coding Agentのセッションを再開できませんでした。",
  "terminal.agentResumeStale": "Agentセッションの状態が変わりました。確認してからもう一度お試しください。",
  "terminal.agentResumeSamePaneBusy": "このシェルにはすでに入力があります。新しいpaneで再開してください。",
  "terminal.agentResumeUnavailable": "このAgentセッションは再開できません。",
  "terminal.agentResumeIdentityChanged": "このaliasのSSH接続先が変わったため、Agentセッションを再開しませんでした。",
  "terminal.progressDialing": "{target}へ通信中 · {position}",
  ...
  "terminal.scrollbackLabel": "セッションあたりのスクロールバック（バイト）",
  ...
  "sync.historySkipped": "現行形式または現在の鍵で開けない履歴ファイルを{count}件スキップしました。",
  ...
  "sync.result.uploaded": "S3転送 {size}（{count}オブジェクト、履歴＋現在版）",
  ...
  "kh.removed": "1 件のエントリを削除しました（履歴ID: {id}）。",
  ...
  "rk.hostTypeHint": "上にHost aliasを入力してください。保存済みの接続があればここに表示されます。",
  "rk.hostsSelected": "{count} 件選択中",
  "rk.hostChoices": "接続先の候補",
  "rk.selectMatches": "一致項目を選択",
  "rk.clearSelection": "解除",
  "rk.noHostMatches": "一致する接続先がありません",
  "rk.chooseHost": "接続先を1件以上選択するか、Host aliasを入力してください。",
