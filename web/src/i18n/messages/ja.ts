...
export const ja = {
  ...
  "workspace.broadcastCommand": "一括実行…",
  "workspace.broadcastHeading": "ターミナルへ一括実行",
  "workspace.broadcastDescription": "コマンドまたはスニペットを対象ごとに確認してから実行します。入力中のキーは共有しません。",
  "workspace.commandClose": "一括実行を閉じる",
