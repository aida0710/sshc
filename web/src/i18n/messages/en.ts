...
export const en = {
  ...
  "terminal.verbosityHint": "Written into the console itself, like ssh -v. Applies to new connections.",
  "terminal.verbosityQuiet": "Say nothing",
  "terminal.verbosityBrief": "What happened (-v)",
  ...
  "terminal.reconnectHint":
    "How many times sshc tries to get a lost connection back. **A console you closed that seems to linger is this, still trying.** The gaps are 1, 2, 5, 10 and 15 seconds, so five attempts take 33 seconds before it gives up. Closing a console yourself never waits.",
