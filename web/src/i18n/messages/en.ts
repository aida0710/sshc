export const en = {
  ...
  "workspace.broadcastCommand": "Broadcast…",
  "workspace.broadcastHeading": "Broadcast to terminals",
  "workspace.broadcastDescription": "Review a command or snippet for each target before running it. Live keystrokes are never shared.",
  "workspace.commandClose": "Close broadcast",
