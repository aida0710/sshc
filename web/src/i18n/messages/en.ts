export const en = {
  ...
  "secrets.totpHost": "Host alias",
  "secrets.totpCredential": "One-time password",
  "secrets.chooseTOTP": "Choose a saved token",
  "secrets.assignTOTP": "Assign to host",
  "secrets.assignTOTPFailed": "The one-time password could not be assigned to that host.",
