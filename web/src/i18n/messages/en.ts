export const en = {
  ...
  "shortcuts.defaultPreset": "Default",
  "shortcuts.presetName": "Preset name",
  "shortcuts.duplicate": "Save a copy",
  "shortcuts.rename": "Rename",
  "shortcuts.delete": "Delete preset",
  "shortcuts.reloadRequired": "Could not save or load presets. Reload to get the latest version before editing.",
  "shortcuts.reload": "Reload",
  "shortcuts.loading": "Loading presets…",
  "shortcuts.hint": "Click a binding, then press a key with Ctrl, Alt or Meta (Command), or a function key. Escape cancels; Tab moves to the next control. Preset contents sync between devices; the selected preset stays in this browser. Editing Default creates your own preset. Deleting a selected preset restores defaults. Browser or OS shortcuts may take priority. Copy, paste and terminal search apply inside the terminal.",
  "shortcuts.palette": "Command search",
  "shortcuts.terminalSearch": "Terminal search",
  "shortcuts.copy": "Copy selection",
  "shortcuts.paste": "Paste",
  "shortcuts.nextSession": "Next connection",
  "shortcuts.previousSession": "Previous connection",
  "shortcuts.home": "Open Home",
  "shortcuts.sftp": "Open SFTP",
  "shortcuts.assign": "Assign shortcut: {action}",
  "shortcuts.clearAction": "Clear shortcut: {action}",
  "shortcuts.clear": "Clear",
  "shortcuts.recording": "Press keys… (Esc to cancel)",
  "shortcuts.unassigned": "Unassigned",
  "shortcuts.reset": "Restore defaults",
  "shortcuts.saved": "Shortcuts saved.",
  "shortcuts.saveFailed": "Could not save. Reload the presets and check the connection and browser storage permissions.",
  "shortcuts.conflict": "Already assigned to {action}. Clear that binding first.",
  "shell.title": "sshc",
  ...
  "palette.kind.command": "Action",
  "palette.newConnection": "Create a connection",
  "palette.newConnectionDetail": "Open the new connection form",
  "palette.openRemoteFiles": "Open remote files",
  "palette.openRemoteFilesDetail": "Browse a host over SFTP",
  "palette.openLocalShell": "Open a local shell",
  "palette.openLocalShellDetail": "Start a terminal on this machine",
  "palette.lockVault": "Lock the vault",
  "palette.lockVaultDetail": "Require the master password again",
  "table.sortAscending": ", sort ascending",
  "table.sortDescending": ", sort descending",
  "section.files": "SFTP",
  "section.snippets": "Snippets",
  "sftp.heading": "Remote files",
  "sftp.tabs": "Remote file tabs",
  "sftp.primaryTabs": "Left pane tabs",
  "sftp.secondaryTabs": "Right pane tabs",
  "sftp.newTab": "New tab",
  "sftp.closeTab": "Close the {name} tab",
  "sftp.resizePanes": "Resize the panes",
  "sftp.dropTabLeft": "Open in a new left pane",
  "sftp.dropTabRight": "Open in a new right pane",
  "sftp.dropTabHere": "Move to this pane",
  ...
  "sftp.local.loading": "Reading the local directory…",
  "sftp.local.dropZone": "Local file list and drop zone",
  "sftp.local.connectRemote": "Connect the remote pane to upload files.",
  "sftp.host": "Host",
  "sftp.noHosts": "No saved hosts",
  "sftp.chooseHost": "Select a host",
  "sftp.chooseHostHint": "Choose Local or a saved SSH host. Connect after choosing an SSH host.",
  "sftp.connect": "Connect",
  "sftp.connecting": "Connecting to {alias}…",
  "sftp.readyToConnect": "{alias} is disconnected",
  "sftp.connectHint": "SFTP does not connect just because you opened the screen or restored a saved tab.",
  "sftp.loading": "Reading the remote directory…",
  "sftp.retry": "Try again",
  "sftp.emptyDirectory": "This directory is empty.",
  "sftp.noFilterMatches": "Nothing here matches the filter.",
  "sftp.clearFilterHint": "Clear the filter to see every entry again.",
  "sftp.undo": "Undo",
  "sftp.dismissUndo": "Dismiss undo notification",
  "sftp.renamedTo": "Renamed to {name}.",
  "sftp.permissionsChanged": "Permissions set to {mode}.",
  "sftp.leaveHeading": "Leave without saving?",
  "sftp.leaveBody": "{path} has changes that are not written to the server.",
  "sftp.leaveDiscard": "Discard and leave",
  "sftp.leaveStay": "Keep editing",
  "sftp.chooseHostHeading": "Choose a connection",
  "sftp.closeHostPicker": "Close host picker",
  "sftp.searchHosts": "Search connections",
  "sftp.searchHostsPlaceholder": "Search aliases, groups, hosts or users",
  "sftp.hostViews": "Host list view",
  "sftp.recentHosts": "Recent",
  "sftp.hostGroups": "Groups",
  "sftp.ungroupedHosts": "No group",
  "sftp.noHostMatches": "No host matches this search.",
  "sftp.hostNoDetails": "SSH host",
  "sftp.hostCurrent": "Current",
  "sftp.lastConnected": "Last connected {at}",
  ...
  "sftp.searchResultsTruncated": "First {count} matches for \u201c{query}\u201d under {path}; the search stopped early.",
  "sftp.searchNoMatches": "Nothing under this directory is named like \u201c{query}\u201d.",
  "sftp.searchEnd": "Leave search",
  "sftp.revealInFolder": "Go to containing folder",
  "sftp.up": "Up",
  ...
  "sftp.selectedCountSize": "{count} selected · {size}",
  "sftp.selectAll": "Select all entries",
  "sftp.selectEntry": "Select {name}",
  "sftp.clearSelection": "Clear selection",
  "sftp.invertSelection": "Invert selection",
  "sftp.copyName": "Copy name",
  "sftp.copyNames": "Copy names",
  "sftp.copyPath": "Copy full path",
  "sftp.copyPaths": "Copy full paths",
  "sftp.openFolder": "Open folder",
  "sftp.editFile": "Edit file",
  "sftp.newFolder": "New folder",
  "sftp.newFile": "New empty file",
  "sftp.duplicate": "Duplicate",
  "sftp.moveTo": "Move to folder",
  "sftp.move": "Move",
  "sftp.upload": "Upload",
  ...
  "sftp.manager.summaryRunning": "{count} active · {progress}% · {speed}/s",
  "sftp.manager.summaryIdle": "{count} transfers",
  "sftp.manager.actions": "Transfer queue actions",
  "sftp.manager.concurrency": "Concurrent transfers",
  "sftp.manager.autoClear": "Clear finished after",
  ...
  "sftp.manager.startProcessing": "Resume processing the transfer queue",
  "sftp.manager.status.held": "Held",
  "sftp.manager.resize": "Drag to resize the transfer queue",
  "sftp.manager.moveUp": "Move {name} earlier in the queue",
  "sftp.manager.moveDown": "Move {name} later in the queue",
  "sftp.manager.collapse": "Collapse Transfer Manager",
  "sftp.manager.expand": "Expand Transfer Manager",
  "sftp.manager.pauseAll": "Pause all",
  "sftp.manager.resumeAll": "Resume all",
  "sftp.manager.cancelAll": "Cancel all",
  "sftp.manager.clearFailed": "Remove failed transfers from the list",
  "sftp.manager.remove": "Remove from list",
  "sftp.manager.controlChanged": "The transfer state changed. The list has been refreshed.",
  "sftp.manager.cleanupFailed": "The remote temporary file could not be removed. Check the connection and try again.",
  "sftp.manager.controlFailed": "The transfer could not be controlled. Check the connection and try again.",
  "sftp.manager.dismissError": "Dismiss error",
  ...
  "sftp.manager.retryFailed": "Retry failed transfers ({count})",
  ...
  "sftp.manager.status.reconcile": "Check the destination",
  ...
  "sftp.name": "Name",
  "sftp.size": "Size",
  "sftp.linkTarget": "Points to",
  "sftp.brokenLink": "{target} (not found)",
  "sftp.calculating": "Calculating…",
  "sftp.partialSizePrefix": "At least ",
  "sftp.sizeUnavailable": "Unavailable",
  "sftp.containedFiles": "Files inside",
  "sftp.containedDirectories": "Folders inside",
  "sftp.type": "Type",
  "sftp.type.file": "File",
  ...
  "sftp.revision": "Revision",
  "sftp.details": "Details",
  "sftp.detailsFor": "Details for {name}",
  "sftp.detailsForCount": "Details for {count} selected items",
  "sftp.preview": "Preview",
  "sftp.properties": "Properties",
  "sftp.previewLoading": "Loading preview…",
  "sftp.previewUnavailable": "This file cannot be previewed here.",
  "sftp.previewTruncated": "Only the beginning of this file is shown.",
  "sftp.selectedItems": "Selected items",
  "sftp.totalSize": "Total size",
  "sftp.actions": "Actions",
  "sftp.entries": "File list",
  "sftp.rename": "Rename",
  "sftp.delete": "Delete",
  "sftp.refreshDirectory": "Refresh directory",
  "sftp.deleteContentsWarning": "Folders and everything inside them will be deleted.",
  "sftp.manager.delete": "Deleting",
  "sftp.chmod": "Change permissions",
  "sftp.chmodRecursive": "Change permissions recursively",
  ...
  "sftp.skip": "Skip",
  "sftp.cancel": "Cancel",
  "sftp.remoteDropTitle": "Transfer remote items",
  "sftp.remoteDropDescription": "Transfer {count} item(s) to {alias}. Data is transferred directly between the two SFTP connections.",
  "sftp.remoteDropInvalid": "This remote drag could not be read.",
  "sftp.copyHere": "Copy here",
  ...
  "sftp.compare.status": "Difference",
  "sftp.compare.same": "Same",
  "sftp.compare.different": "Changed",
  "sftp.compare.left_only": "Left only",
  "sftp.compare.right_only": "Right only",
  "sftp.compare.type_mismatch": "Different type",
  "sftp.compare.leftToRight": "Copy left → right",
  "sftp.compare.rightToLeft": "Copy right → left",
  "sftp.save": "Save",
  "sftp.close": "Close",
  ...
  "sftp.newFilePrompt": "File name",
  "sftp.moveToPrompt": "Destination folder",
  "sftp.pathAbsolute": "Enter an absolute path beginning with /.",
  ...
  "terminal.replayTruncated":
    "Some output produced while the terminal link was offline is no longer in the engine replay buffer.",
  "terminal.clipboardRefused": "The clipboard could not be accessed.",
  "terminal.pasteHeading": "Review paste to {target}",
  "terminal.pasteDescription":
    "Review this paste before anything is sent. Logical line count: {lines}.",
  "terminal.pasteRiskLineBreak": "Line breaks can run one or more commands immediately.",
  "terminal.pasteRiskControl": "Terminal control characters can change terminal state or input.",
  "terminal.pastePreview": "Paste preview with control characters made visible",
  "terminal.pastePreviewTruncated": "The preview is truncated. The action still applies to the complete paste.",
  ...
  "terminal.openDirectoryInSFTP": "Open current directory in SFTP",
  ...
  "terminal.settingsSaved":
    "Saved. Clipboard settings apply immediately; other settings apply to newly opened terminals.",
  ...
  "terminal.backgroundChoose": "Change",
  "terminal.backgroundClear": "Clear",
  "terminal.backgroundNotSelected": "No background image is selected",
  "terminal.backgroundLibrary": "Background image library",
  "terminal.backgroundClose": "Close",
  "terminal.backgroundSearch": "Search images",
  "terminal.backgroundEmpty": "No saved images",
  "terminal.backgroundEmptyHint": "Add an image to choose it here.",
  "terminal.backgroundActions": "Actions for {name}",
  "terminal.backgroundRenameAction": "Rename",
  "terminal.backgroundDeleteAction": "Delete",
  "terminal.backgroundDeleteHeading": "Delete background image?",
  "terminal.backgroundDeleteHint": "Delete {name} and clear settings that use it. This cannot be undone.",
  "terminal.backgroundUse": "Use this image",
  "terminal.backgroundUseNone": "Select no image",
  "terminal.backgroundCapacityHeading": "Storage capacity",
  "terminal.backgroundCapacityUsage": "{used} of {capacity} used",
  "terminal.backgroundCapacityLabel": "Limit",
  "terminal.backgroundCapacitySave": "Save limit",
  ...
  "terminal.backgroundRenameSubmit": "Rename",
  "terminal.backgroundRenameCancel": "Cancel",
  ...
  "connection.vpnLabel": "VPN profile",
  "connection.vpnHint": "Connect through the VPN of the chosen VPN profile. The destination is this connection's HostName and Port. VPN profiles are created on the VPN screen.",
  ...
  "menu.others": "Others",
  "menu.signOutHeading": "Sign out",
  "menu.signOutHint": "Removes this browser's session and registration. To open sshc again, run sshc (or sshc open) in a terminal and open the URL it prints.",
  "menu.signOut": "Sign out of this browser",
  "menu.signOutConfirmHeading": "Sign out of this browser?",
  "menu.signOutConfirmBody": "Open sessions keep running in the engine. This browser's registration is removed, so it will not re-enter on its own after an engine restart.",
  "menu.signOutCancel": "Cancel",
  "menu.signOutFailed": "Could not sign out.",
  ...
  "secrets.totpValue": "Setup key or otpauth URI",
  ...
  "secrets.totpHeading": "One-time passwords (TOTP)",
  "secrets.newTOTPName": "New one-time password name",
  "secrets.newTOTPValue": "Base32 setup key or otpauth URI",
  "secrets.storeTOTP": "Store one-time password",
  ...
  "secrets.totpCopyCurrent": "Copy the current code for {name}",
  "secrets.totpCopyPrevious": "Copy the previous code for {name}",
  "secrets.totpCopyNext": "Copy the next code for {name}",
  ...
  "lock.alreadyExists":
    "A vault already exists in app storage. Enter its master password to unlock it.",
  ...
  "vpn.heading": "VPN",
  "vpn.description":
    "Route chosen connections through a VPN of their own. The tunnel lives in a container held by the engine, so this machine's default route and DNS are untouched. Requires Docker on this machine.",
  "vpn.loading": "Loading VPN profiles…",
  "vpn.failed": "The VPN operation failed.",
  "vpn.unavailable": "This machine cannot open VPN routes.",
  "vpn.unavailableDetail": "Details: {detail}",
  "vpn.empty": "No VPN profiles yet. Add one below.",
  ...
  "vpn.phaseApproval": "waiting for approval on the phone",
  "vpn.connect": "Connect",
  "vpn.disconnect": "Disconnect",
  "vpn.remove": "Remove",
  "vpn.rename": "Rename",
  "vpn.edit": "Edit",
  "vpn.renameTitle": "Rename {name}",
  "vpn.renameHint": "The settings of the connections this profile is attached to, and its stored secrets, move to the new name. A running route is disconnected first.",
  "vpn.renameLabel": "New name",
  ...
  "vpn.close": "Close",
  "vpn.profileChip": "VPN: {name}",
  "vpn.profileChipHint": "This connection goes through the VPN route {name}.",
  ...
  "vpn.addHeading": "Add a VPN profile",
  "vpn.addHint": "The destination is the HostName and Port of each connection this profile is attached to. Secrets are stored in the vault and never shown again.",
  "vpn.editHeading": "Edit {name}",
  "vpn.editHint": "Secret fields left blank keep the stored values. After changing the type, enter the secrets of the new type.",
  "vpn.name": "Name",
  "vpn.nameFixedHint": "Use Rename to change the name.",
  "vpn.backend": "Type",
  "vpn.dns": "DNS inside the VPN",
  "vpn.dnsHint": "Needed when a connection using this profile has a host name as its HostName; the name is resolved inside the VPN. Up to three IPv4 addresses, comma separated.",
  "vpn.server": "VPN server",
  "vpn.peerPublicKey": "Peer public key",
  "vpn.address": "Tunnel address",
  "vpn.privateKey": "Private key",
  ...
  "vpn.secondFactorHint": "What the device does after the password.",
  "vpn.secondFactorNone": "None",
  "vpn.secondFactorApprove": "Wait for approval on the phone (Duo Mobile and friends)",
  "vpn.secondFactorTOTP": "Generate a code from a stored seed",
  "vpn.secondFactorSecret": "Second factor TOTP seed",
  "vpn.approvalWord": "Word to send as the second answer",
  "vpn.approvalWordHint": "Only when the device asks a second question. Blank sends nothing. Duo takes `push`, and often `phone` or `sms`.",
  "vpn.ike": "IKE proposals",
  "vpn.esp": "ESP proposals",
  "vpn.proposalsHint": "Only needed when an older device rejects the defaults. Blank uses them.",
  "vpn.secretHint": "Not shown again after saving.",
  "vpn.secretKeepHint": "Leave blank to keep the stored value.",
  "vpn.cancel": "Cancel",
  "vpn.save": "Save",
  "vpn.dockerMissing": "Docker was not found. VPN routes need Docker. Install Docker Desktop or similar.",
  ...
  "vpn.failure.unknown": "The reason could not be read. Check the logs.",
  "vpn.failure.timeout": "The connection timed out.",
  "vpn.failure.server_unresolved": "The VPN server's name could not be resolved. Check how the server is written.",
  "vpn.failure.ipsec_negotiation": "IPsec negotiation failed. Check the pre-shared key and the cipher suites.",
  "vpn.failure.ppp_authentication": "PPP authentication failed. Check the username and the password.",
  "vpn.failure.openconnect_failed": "Check the username, the password, the second factor and the certificate.",
  "vpn.failure.handshake_timeout": "The handshake failed. Check the keys and the server.",
  "vpn.failure.tunnel_lost": "The VPN was disconnected right after the connection was established.",
  "vpn.targetFailure.target_unresolved": "The DNS servers inside the VPN could not resolve the destination. Check the DNS servers and HostName.",
  "vpn.targetFailure.target_is_server": "The destination is the VPN server's own address. The VPN server itself cannot be reached through the VPN.",
  "vpn.targetFailure.target_unreachable": "The destination did not answer or refused the connection. Check HostName and Port.",
  "vpn.targetFailure.tunnel_lost": "The VPN was disconnected. Connect again.",
  "vpn.destination.format": "The destination's HostName is not in a valid form.",
  "vpn.destination.out_of_range": "The destination's Port must be between 1 and 65535.",
  "vpn.destination.not_ipv4": "A destination through a VPN must be an IPv4 address or a host name. IPv6 addresses are not supported.",
  "vpn.destination.unroutable": "This address (loopback, multicast or unspecified) cannot be used through a VPN.",
  "vpn.destination.name_needs_dns": "To use a host name as the destination, give the VPN profile a DNS server inside the VPN.",
  "vpn.containerForeign": "A container of the same name was created by something other than sshc, so the operation was stopped.",
  "vpn.secretsMissing": "No secrets (private key or password) are stored for this VPN profile.",
  "vpn.profileInvalid": "The VPN profile has a value that cannot be used. Check the VPN server and the DNS servers.",
  ...
  "vpn.connectionUnknown": "This connection cannot have a VPN profile. Connections defined only in an Included file or by a wildcard Host cannot be edited by sshc.",
  "vpn.vaultLocked": "The vault is locked. Unlock it and try again.",
  "vpn.vaultMissing": "There is no vault yet. Create one, then try again.",
  "vpn.field.required": "Enter a value.",
  "vpn.field.format": "This is not written in a form this field accepts.",
  "vpn.field.too_long": "Too long: up to {limit} characters.",
  "vpn.field.too_many": "Too many: up to {limit}.",
  "vpn.field.out_of_range": "The port must be between 1 and 65535.",
  "vpn.field.not_ipv4": "Not an IPv4 address.",
  "vpn.field.unroutable": "No route can be built to this address (loopback, multicast or unspecified).",
  "vpn.field.unsupported": "This value cannot be used.",
  "vpn.field.unexpected": "This setting is not used by the chosen type.",
  ...
  "notice.group_cycle": "This group's parent hierarchy is cyclic, so the group was skipped.",
  ...
  "notice.group_directory_missing":
    "This group is declared, but its directory is missing. Its settings will not be loaded until you create the directory and add configuration files.",
  ...
  "reveal.warning":
    "The private key will appear on this page. Anyone who can view the screen can copy it. sshc cannot protect the key from browser extensions or clipboard-history tools. Each reveal is recorded in History, but the key itself is not.",
  ...
  "sync.warning":
    "The sync includes regular files under ~/.ssh that do not match the exclusion rules; this may include private keys. The snapshot is encrypted on this machine with the key below before upload, so the storage provider does not receive the synchronised content in plaintext. However, anyone with the bucket credentials can download the encrypted snapshot and attempt to guess the encryption key offline without a time limit.",
  ...
  "diag.explainFailed": "Could not analyse the settings for this alias.",
  ...
  "diag.canRunCommand":
    "This connection includes settings that may cause OpenSSH to run commands",
  ...
  "rk.valuesFromSshG": "Resolved by OpenSSH using ssh -G",
  ...
  "explorer.newFileNote":
    "To make OpenSSH read a new file, reference it with an Include directive in ~/.ssh/config. Move connections between groups on the Connections screen.",
  ...
  "conn.basicStoredTOTP": "One-time password (TOTP)",
  ...
  "conn.basicKeyPassphraseStoredNote":
    "This saves the passphrase used to decrypt the private key. It does not change the passphrase that encrypts the private-key file.",
  ...
  "conn.basicRemoveTOTP": "Remove TOTP assignment",
  "conn.basicChooseSavedTOTP": "Saved TOTP",
  "conn.basicNoSavedTOTPs": "No TOTP is stored in Vault",
  "conn.basicTOTPNote":
    "Register TOTP seeds in the Vault, then assign one to this connection here. sshc only enters the code when an authentication prompt explicitly requests it, such as “Verification code”.",
  ...
  "conn.analysisExecutableHeading":
    "This connection includes directives that may cause OpenSSH to run commands",
  "conn.analysisTokenWarning":
    "OpenSSH does not shell-escape expanded tokens. Host name, port, or user values may therefore reach the command's shell unescaped.",
  "conn.analysisSources": "Configuration lines related to this connection",
  ...
  "keys.passphraseNote":
    "The passphrases typed here are used only for this change and are not stored. Use “Save passphrase” in the key list when you want the sshc Vault to remember one.",
  ...
  "keys.savePassphrase": "Change passphrase",
  ...
  "keys.trashEmpty": "Trash is empty.",
  "keys.colFiles": "Files",
  "keys.colAge": "Age",
  ...
  "keys.confirmPurge": "Confirm permanent deletion",
