export const en = {
  ...
  "connection.vpnLabel": "VPN route",
  "connection.vpnHint": "Reach this connection from inside the chosen VPN. Routes are defined on the VPN screen.",
  "connection.vpnNone": "No VPN",
  "connection.vpnMissing": "{name} (profile is gone)",
  "connection.vpnTargetMismatch": "{name} (reaches {target}, not this connection)",
  "connection.vpnTargetMismatchHint": "This connection goes to {address}, but {name} only reaches {target}. Choose a profile whose target matches, or change HostName and Port.",
  ...
  "vpn.unavailable": "This machine cannot open VPN routes: {detail}",
  ...
  "vpn.renameHint": "The connections routed through it and the stored secrets move with the name. A running route is taken down first.",
  "vpn.renameLabel": "New name",
  "vpn.renameAction": "Rename",
  "vpn.renameEmpty": "Enter a name.",
  "vpn.logs": "Logs",
  ...
  "vpn.connections": "Connections through this route",
  "vpn.noConnections": "None yet.",
  "vpn.bindLabel": "Choose a connection",
  "vpn.bindChoose": "Select one",
  "vpn.bindAction": "Route through this VPN",
  "vpn.unbindAction": "Stop routing {alias} through {name}",
  "vpn.addHeading": "Add a VPN profile",
  "vpn.addHint": "One profile reaches one target. Secrets are stored in the vault and never returned to this screen.",
  "vpn.name": "Name",
  "vpn.backend": "Type",
  ...
  "vpn.cancel": "Cancel",
  "vpn.save": "Save",
  "vpn.dockerMissing": "Docker is not available. Check that it is running and that this user may talk to it.",
  "vpn.tunnelDeviceMissing": "This machine does not have the tunnel device this type needs.",
  "vpn.imageBuildFailed": "The VPN container image could not be built. Check the network and Docker.",
  "vpn.sessionFailed": "The VPN route did not come up. {reason}",
  ...
  "vpn.failure.timeout": "The route did not come up within the time limit.",
  "vpn.failure.server_unresolved": "The VPN server's name could not be resolved. Check how the server is written.",
  "vpn.failure.ipsec_negotiation": "IPsec was not established. Check the pre-shared key and the proposals.",
  "vpn.failure.ppp_authentication": "PPP authentication failed. Check the username and the password.",
  "vpn.failure.openconnect_failed": "openconnect could not connect to the VPN server.",
  "vpn.failure.handshake_timeout": "No handshake with the WireGuard peer. Check the keys and the server.",
  "vpn.failure.target_unresolved": "The target's name could not be resolved inside the VPN. Check the DNS servers and the target.",
  "vpn.failure.tunnel_lost": "The tunnel dropped after the route was ready.",
  "vpn.containerForeign": "A container of that name belongs to something else, so nothing was changed.",
  ...
  "vpn.field.name_needs_dns": "A name needs the DNS servers inside the VPN as well.",
  "vpn.field.unsupported": "This version does not know this value.",
  "vpn.field.unexpected": "These settings belong to a different type.",
