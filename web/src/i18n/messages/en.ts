export const en = {
  ...
  "vpn.close": "Close",
  "vpn.routeChip": "VPN: {name}",
  "vpn.routeChipHint": "This connection goes through the VPN route {name}.",
  ...
  "vpn.sessionFailed": "The VPN route did not come up. Check the settings and the secrets.",
