export const en = {
  ...
  "sync.exclusions.defaults":
    "There is no .sshcignore yet. The built-in rules exclude OS metadata, backups, temporary files, lock files, authorized_keys, known_hosts, and known_hosts.old. Saving shares the rules with every machine.",
