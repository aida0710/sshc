export const en = {
  ...
  "shortcuts.description": "Customize application shortcuts for this browser.",
  "shortcuts.hint": "Click a binding, then press a key with Ctrl, Alt or Meta (Command), or a function key. Escape cancels; Tab moves to the next control. Changes apply immediately and stay in this browser. Browser or OS shortcuts may take priority. Copy, paste and terminal search apply inside the terminal.",
  ...
  "shortcuts.saveFailed": "Could not save. Check browser storage permissions.",
