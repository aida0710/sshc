export const en = {
  ...
  "sftp.upload": "Upload",
  "sftp.dropHint": "or drop files here",
  "sftp.dropNow": "Drop to upload each file",
  "sftp.dropZone": "Upload files to the current remote directory",
  ...
  "workspace.broadcast": "Broadcast input",
  "workspace.saved": "Saved workspaces",
  "workspace.new": "New workspace",
  "workspace.save": "Save layout",
  ...
  "workspace.swapWith": "Exchange with {alias}",
  "workspace.reconnecting": "Reconnect this pane to continue.",
  "workspace.openFailed": "The additional connection could not be opened.",
  "workspace.namePrompt": "Workspace name",
  "workspace.commandCenter": "Run command",
  "workspace.commandClose": "Close command center",
  ...
  "workspace.targetMode": "Execution targets",
  "workspace.oncePerHost": "Once per host",
  "workspace.oncePerPane": "Once per pane",
  "workspace.targetCount": "{count} targets",
  "workspace.noDuplicatePanes": "Each pane already points to a different host.",
  "workspace.executionNotice": "Commands run through separate SSH executions. Live pane working directories, environment variables, and shell state are not inherited; disconnected panes remain eligible by alias.",
  "workspace.previewHeading": "Review workspace execution",
  "workspace.runTargets": "Run on {count} targets",
