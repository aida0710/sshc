...
export const en = {
  ...
  "terminal.duplicate": "Open another to the same place",
  ...
  "terminal.proxyCommandRefused": "ProxyCommand starts a program, and sshc starts nothing to connect. Use ProxyJump, or connect from a terminal with ssh.",
  ...
  "terminal.startHeading": "Where local shells start",
  "terminal.startNote": "A local shell opens here, and the commands you type run from here. Leave it empty to start in your home directory.",
  "terminal.startLabel": "Starting directory",
  "terminal.startHint": "Write it as ~/work or as an absolute path. The ~ is kept as written, so the same setting means the same thing on another machine.",
  "terminal.startSave": "Save",
  "terminal.startSaved": "Saved. Consoles opened from now on start there.",
  ...
  "terminal.startSaveFailed": "The starting directory could not be saved.",
  ...
  "desktop.loginItemWins": "Start at login is on, so the engine runs whatever this says: stopping it only makes the system start it again. Turn that off first if you want closing the window to end it.",
