export const en = {
  ...
  "sftp.createActions": "Create or upload",
  "sftp.noSelectionActions": "Select an item to see actions",
  "sftp.selectedActions": "Actions for {name}",
  "sftp.selectedActionsCount": "Actions for {count} selected items",
  "sftp.selected": "Selected: {name}",
  "sftp.selectedCount": "{count} selected",
  "sftp.selectAll": "Select all entries",
  "sftp.selectEntry": "Select {name}",
  ...
  "sftp.chmodInvalid": "Enter three octal digits from 000 to 777.",
  ...
  "sftp.nameRequired": "Enter a name.",
  "sftp.nameInvalid": "A name cannot contain a slash.",
  "sftp.renameUnchanged": "Enter a different name.",
  "sftp.deleteHeading": "Delete this remote entry?",
  "sftp.deleteHeadingCount": "Delete {count} remote entries?",
  "sftp.deleteFailedCount": "Could not delete {count} selected entries.",
  ...
  "workspace.nameRequired": "Enter a saved layout name.",
