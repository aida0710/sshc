...
function buildApi(overrides: Partial<IntegrationsApi> = {}): IntegrationsApi {
  return {
    ...
    passwordVault: vi.fn().mockResolvedValue({ exists: false, unlocked: false, biometric: { available: false, enabled: false }, aliases: [], dedicatedKeyPassphrases: [] }),
    ...
    lockVault: vi.fn().mockResolvedValue({ exists: true, unlocked: false, biometric: { available: false, enabled: false }, aliases: [], dedicatedKeyPassphrases: [] }),
    ...
    storePassword: vi.fn().mockResolvedValue({ exists: true, unlocked: true, biometric: { available: false, enabled: false }, aliases: [], dedicatedKeyPassphrases: [] }),
    forgetPassword: vi.fn().mockResolvedValue({ exists: true, unlocked: true, biometric: { available: false, enabled: false }, aliases: [], dedicatedKeyPassphrases: [] }),
    ...
    unlockWithBiometric: vi.fn().mockResolvedValue({ exists: true, unlocked: true, biometric: { available: false, enabled: false }, aliases: [], dedicatedKeyPassphrases: [] }),
    enableBiometric: vi.fn().mockResolvedValue({ exists: true, unlocked: true, biometric: { available: false, enabled: false }, aliases: [], dedicatedKeyPassphrases: [] }),
    disableBiometric: vi.fn().mockResolvedValue({ exists: true, unlocked: true, biometric: { available: false, enabled: false }, aliases: [], dedicatedKeyPassphrases: [] }),
