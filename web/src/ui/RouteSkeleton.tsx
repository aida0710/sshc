  ...
  return (
    <div aria-hidden="true" className="h-full overflow-hidden p-6">
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        ...
        <div className="sshc-card grid gap-px overflow-hidden rounded-xl bg-line sm:grid-cols-3">
        ...
        <div className="sshc-card flex flex-col gap-4 rounded-xl bg-card p-4">
