...
func validTerminalWaitState(value string) bool {
	return generatedStringSet(value, []string{"connecting", "connected", "reconnecting", "exited"})
}
...
var cliCompletionGrammar = completionGrammar{
	topLevel:            []string{"engine", "ssh", "info", "sync", "terminal", "sftp", "serial", "telnet", "open", "status", "update", "service", "otp", "vpn", "vault", "version", "help", "completion"},
	helpTopics:          []string{"engine", "ssh", "info", "sync", "terminal", "sftp", "serial", "telnet", "open", "status", "update", "service", "otp", "vpn", "vault", "version", "completion"},
	...
	waitStates:          []string{"connecting", "connected", "reconnecting", "exited"},
	...
	sftpOptions:         []string{"-r", "--recursive", "--overwrite", "--skip-existing", "--dry-run", "-j", "--jobs", "--split-size", "--split-jobs", "--chunk-size", "--max-depth", "--max-entries", "--max-total-size", "--json", "-y", "--yes", "--help"},
	sftpSettingsOptions: []string{"--split-size", "--split-jobs", "--chunk-size", "--json", "--help"},
}
