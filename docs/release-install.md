...
```sh
SSHC_VERSION=v0.33.7 sh -c \
  'curl -fsSL https://raw.githubusercontent.com/aida0710/sshc/v0.33.7/install.sh | sh'
```
...
```powershell
$env:SSHC_VERSION = 'v0.33.7'
irm https://github.com/aida0710/sshc/releases/download/v0.33.7/install.ps1 | iex
```
