...
```sh
SSHC_VERSION=v0.33.5 sh -c \
  'curl -fsSL https://raw.githubusercontent.com/aida0710/sshc/v0.33.5/install.sh | sh'
```
...
```powershell
$env:SSHC_VERSION = 'v0.33.5'
irm https://github.com/aida0710/sshc/releases/download/v0.33.5/install.ps1 | iex
```
