...
```sh
SSHC_VERSION=v0.19.0 sh -c \
  'curl -fsSL https://raw.githubusercontent.com/aida0710/sshc/v0.19.0/install.sh | sh'
```
...
```powershell
$env:SSHC_VERSION = 'v0.19.0'
irm https://github.com/aida0710/sshc/releases/download/v0.19.0/install.ps1 | iex
```
