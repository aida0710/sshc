...
type Mode struct {
	...
	FlowControl       FlowControl      // Flow control (none, RTS/CTS, or XON/XOFF)
	InitialStatusBits *ModemOutputBits // Initial output modem bits status (if nil defaults to DTR=true and RTS=true)
}

// FlowControl describes how transmission is paused and resumed.
type FlowControl int

const (
	// NoFlowControl disables hardware and software flow control.
	NoFlowControl FlowControl = iota
	// RTSCTSFlowControl enables bidirectional RTS/CTS hardware flow control.
	RTSCTSFlowControl
	// XONXOFFFlowControl enables bidirectional XON/XOFF software flow control.
	XONXOFFFlowControl
)
