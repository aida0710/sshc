...
func (port *windowsPort) setModeParams(mode *Mode, params *windows.DCB) {
	...
	setModeFlowControl(mode.FlowControl, params)
}

func setModeFlowControl(flow FlowControl, params *windows.DCB) {
	wasRTSCTS := params.Flags&dcbRTSControlMask == dcbRTSControlHandshake
