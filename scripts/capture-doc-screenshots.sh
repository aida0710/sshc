...
visual_version=$(git describe --tags --abbrev=0 --match 'v*' 2>/dev/null || printf 'development')
SSHC_VISUAL_DIR="$visual_dir" SSHC_VISUAL_VERSION="$visual_version" npm run e2e --prefix web -- \
  e2e/shell.spec.ts \
...
install_image vault-account-passwords.png pages/public/images/credentials-desktop.png
...
install_image sftp-two-pane-desktop-en.png pages/public/images/sftp-two-pane-en.png
install_image sftp-two-pane-desktop.png pages/public/images/sftp-two-pane-ja.png
install_image sftp-compare-en.png pages/public/images/sftp-compare-en.png
install_image sftp-compare-ja.png pages/public/images/sftp-compare-ja.png
