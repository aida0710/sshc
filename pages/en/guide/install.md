...
Without Homebrew, pin both the installer URL and the binary version to the same release. This example installs `v0.36.0`.

```sh
SSHC_VERSION=v0.36.0 sh -c \
  'curl -fsSL https://raw.githubusercontent.com/aida0710/sshc/v0.36.0/install.sh | sh'
```
