...
Without Homebrew, pin both the installer URL and the binary version to the same release. This example installs `v0.37.1`.

```sh
SSHC_VERSION=v0.37.1 sh -c \
  'curl -fsSL https://raw.githubusercontent.com/aida0710/sshc/v0.37.1/install.sh | sh'
```
