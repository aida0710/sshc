...
Homebrewを使わない場合は、インストーラーとバイナリのバージョンを同じReleaseタグに固定してください。次は`v0.39.3`を導入する例です。

```sh
SSHC_VERSION=v0.39.3 sh -c \
  'curl -fsSL https://raw.githubusercontent.com/aida0710/sshc/v0.39.3/install.sh | sh'
```
