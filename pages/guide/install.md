...
Homebrewを使わない場合は、インストーラーとバイナリのバージョンを同じReleaseタグに固定してください。次は`v0.38.1`を導入する例です。

```sh
SSHC_VERSION=v0.38.1 sh -c \
  'curl -fsSL https://raw.githubusercontent.com/aida0710/sshc/v0.38.1/install.sh | sh'
```
