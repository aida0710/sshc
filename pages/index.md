...
<main class="sshc-home">
  ...
  <section class="sshc-home-section">
    ...
    <div class="sshc-feature-grid">
      ...
      <article class="sshc-feature"><img class="sshc-feature-image" src="/images/sftp-desktop.png" alt="リモートファイルを操作するSFTP画面" width="1280" height="720"><div class="sshc-feature-body"><span class="index">05</span><h3>SFTP</h3><p>リモートファイルの編集、フォルダ転送、2つの接続先の比較と直接コピーを、Terminalと行き来しながら操作できます。</p></div></article>
      <article class="sshc-feature"><img class="sshc-feature-image" src="/images/sync-desktop-ja.png" alt="暗号化スナップショットを管理するSync画面" width="1280" height="720"><div class="sshc-feature-body"><span class="index">06</span><h3>暗号化同期</h3><p>接続設定、認証情報、スニペット、同期対象のSSH鍵をこのマシン上で暗号化し、利用者が用意したS3互換ストレージを介して同期できます。ストレージ事業者は、暗号化された内容を平文では取得できません。</p></div></article>
    </div>
  </section>
