...
<main class="sshc-home">
  ...
  <section class="sshc-home-section">
    ...
    <div class="sshc-feature-grid">
      ...
      <article class="sshc-feature"><img class="sshc-feature-image" src="/images/sftp-desktop.png" alt="リモートファイルを操作するSFTP画面" width="1280" height="720"><div class="sshc-feature-body"><span class="index">05</span><h3>SFTP</h3><p>Terminalを使いながら、リモートファイルの編集やフォルダー転送を行えます。ファイル転送は条件を満たせば途中から再開できます。</p></div></article>
